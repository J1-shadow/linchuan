		...
		<div class="container">
			<div class="login-body">
				...
				<div class="login-info">
					<form method="post">
						<input type="text" class="user" name="Cno" placeholder="客户编号" required="">
						<input type="text" class="user" name="Cname" placeholder="姓名" required="">
						<input type="text" class="user" name="Cid" placeholder="身份证" required="">
						<input type="text" class="user" name="Ctel" class="lock" placeholder="手机号码">
						<input type="submit" name="hahaha" value="注册">
						<div class="signup-text">
							<a href="login.php">注册好了？来登陆吧</a>
						</div>
					</form>
					<?php
